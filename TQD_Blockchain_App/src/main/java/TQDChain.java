...
public class TQDChain {
    ...
    public static TQDWallet walletA; //Ví A
    public static TQDWallet walletB; //Ví B
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các ví
        walletA = new TQDWallet();
        walletB = new TQDWallet();
        TQDWallet coinbase = new TQDWallet();
